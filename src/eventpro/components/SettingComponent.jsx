...
import { updateLayout, updateColor, updateFontFamily, updateFontSize, updateLineHeight, updateBackgroundImage, updateBorderRadius, updateBoxShadow } from '../../store/slices/eventpro/settingsSlice';
