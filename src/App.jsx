...
const App = () => {
  ...
  const handleAuth = () => {
    ...
    // Handle user query parameter (if still needed)
    if (user) {
      try {
    ...
    if (platform === 'eventpro' && !proAuthenticated && !proLoading && !['/event-form', '/eventpro/register', '/eventpro/forgot-password', '/eventpro/reset-password'].includes(location.pathname)) {
